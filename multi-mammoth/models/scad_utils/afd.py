...
from models.scad_utils.conditional_bn import ConditionalBatchNorm1d
from models.scad_utils.conditional_bn import ConditionalBatchNorm2d
...
class DoubleAttn(nn.Module):
    ...
    def forward(self, fm_t: torch.Tensor, tasks_id: torch.Tensor):
        ...
        x = x.view(-1, w, h, self.c, 2)     # [64, 32, 32, 64, 2]
