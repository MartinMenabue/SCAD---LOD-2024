...
class ResEncoder(Encoder):
    ...
    def __init__(self, args, encoded_image_size=14):
        ...
        self.nb_classes = self.seq_dataset.N_CLASSES
        if args.pretrained:
            resnet = torchvision.models.resnet101(pretrained=args.pretrained)  # pretrained ImageNet ResNet-101
        else:
            resnet = torchvision.models.resnet101(pretrained=args.pretrained, num_classes=self.nb_classes)  # pretrained ImageNet ResNet-101
        ...
        self.fine_tune(fine_tune=args.fine_tune)
