...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--loss_function', type=str, default='bce', choices=['bce', 'asymmetric'], help='Loss function to use')
    parser.add_argument('--gamma_pos', type=float, default=1.0, help='Gamma for the positive class')
    parser.add_argument('--gamma_neg', type=float, default=2.0, help='Gamma for the negative class')
    parser.add_argument('--loss_w', type=float, default=1.0, help='Weight for the loss')
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--stop_after', type=int, default=6, help="Task limit")
